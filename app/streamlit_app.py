...
st.markdown(
    ...
    /*
       Explicit light idle states prevent Streamlit/browser theme defaults from
       rendering dark buttons with unreadable text. Applies to Predict Report,
       Load Example, Clear Input, Download Summary, and Clear and Analyze Another Report.
    */
    div.stButton > button,
    ...
    button[data-testid="baseButton-secondary"] {
        ...
        transition: background-color .20s ease, color .20s ease,
                    border-color .20s ease, transform .16s ease !important;
    }
    ...
    button[data-testid="baseButton-secondary"]:focus-visible {
        ...
        color: #071C4D !important;
        border-color: var(--action) !important;
        box-shadow: 0 0 0 3px rgba(39, 110, 241, .18) !important;
    }

    /* Keep the first workflow action (Predict Report) visually primary. */
    div[data-testid="column"]:first-of-type div.stButton > button {
        background-color: var(--action) !important;
        color: #FFFFFF !important;
        border-color: var(--action) !important;
    }
    div[data-testid="column"]:first-of-type div.stButton > button p,
    div[data-testid="column"]:first-of-type div.stButton > button span {
        color: #FFFFFF !important;
    }
    ...
    /* Technical Details: readable in collapsed, hovered, focused, and expanded states. */
    ...
    div[data-testid="stExpander"] details summary {
        ...
        transition: background-color .20s ease, color .20s ease !important;
    }
    div[data-testid="stExpander"] details summary p,
    div[data-testid="stExpander"] details summary span,
    div[data-testid="stExpander"] details summary svg {
        color: #071C4D !important;
        fill: #071C4D !important;
        opacity: 1 !important;
    }
