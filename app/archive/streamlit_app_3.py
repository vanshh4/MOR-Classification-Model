...
# The toggle is rendered before the main page content so its state can control
# all CSS variables on the current Streamlit rerun.
theme_col_1, theme_col_2 = st.columns([8.5, 1.5])
with theme_col_2:
    st.toggle("Dark mode", key="dark_mode", help="Switch between light and dark Flight Safety themes.")
...
if st.session_state.dark_mode:
    THEME = {
        ...
        "button_idle": "#DDE7F5",
        "button_text": "#071C4D",
        "button_secondary": "#223149",
        "button_secondary_text": "#F3F6FB",
        "table_header": "#263B59",
        "table_alt": "#15243A",
    }
else:
    THEME = {
        ...
        "button_idle": "#E8EEF7",
        "button_text": "#071C4D",
        "button_secondary": "#F8FAFC",
        "button_secondary_text": "#173E8F",
        "table_header": "#E8EEF7",
        "table_alt": "#F8FAFC",
    }
...
st.markdown(
    ...
    :root {{
        ...
        --border: {THEME["border"]};
        --nav-bg: {THEME["nav"]};
        --intro-bg: {THEME["intro"]};
        --button-idle: {THEME["button_idle"]};
        --button-text: {THEME["button_text"]};
        --button-secondary: {THEME["button_secondary"]};
        --button-secondary-text: {THEME["button_secondary_text"]};
        --table-header: {THEME["table_header"]};
        --table-alt: {THEME["table_alt"]};
        --critical: #B42318;
        --safe: #027A48;
        --review: #B54708;
        --info: #175CD3;
    ...
    /* Clear, readable idle states for every Streamlit action button. */
    div.stButton > button,
    ...
    div.stDownloadButton > button:hover {{
        background: var(--button-idle) !important;
        color: var(--button-text) !important;
        border-color: var(--action) !important;
    }}
    /* The first action remains the single primary action. */
    ...
    div[data-testid="column"]:first-of-type div.stButton > button:hover {{
        background: #1E5ED4 !important;
        color: #FFFFFF !important;
        border-color: #1E5ED4 !important;
    }}
    ...
    .why-box {{ background: var(--card); border: 1px solid var(--border); border-left: 4px solid var(--info); padding: 17px 18px; margin: 20px 0; }}
    ...
    .technical-table {{ width: 100%; border-collapse: collapse; background: var(--card); font-size: 13px; }}
    .technical-table th {{ background: var(--table-header); color: var(--navy); text-align: left; padding: 10px 12px; border-bottom: 1px solid var(--border); }}
    .technical-table td {{ color: var(--text); padding: 10px 12px; border-bottom: 1px solid #E5EAF2; }}
    .technical-table tr:nth-child(even) td {{ background: var(--card-alt); }}
    ...
    div[data-testid="stCodeBlock"] code {{ color: var(--text) !important; }}
